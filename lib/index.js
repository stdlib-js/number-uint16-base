...
*/
setReadOnly( ns, 'add', require( '@stdlib/number-uint16-base-add' ) );
...
*/
setReadOnly( ns, 'identity', require( '@stdlib/number-uint16-base-identity' ) );
...
*/
setReadOnly( ns, 'mul', require( '@stdlib/number-uint16-base-mul' ) );
...
*/
setReadOnly( ns, 'sub', require( '@stdlib/number-uint16-base-sub' ) );
