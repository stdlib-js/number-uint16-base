...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint16-base@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { fromBinaryStringUint16, toBinaryStringUint16 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint16-base@v0.2.0-deno/mod.js';
```
